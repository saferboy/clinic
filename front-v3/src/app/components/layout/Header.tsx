          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                <div className="text-xs font-medium text-foreground">{currentUser.name.split(' ')[0]}</div>
                <div className="text-xs text-muted-foreground">{getStatusLabel(currentUser.role)}</div>
              </div>
